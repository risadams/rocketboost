...
function isPreloadable(linkElement) {
  ...
  if (!allowExternalLinks && linkElement.origin != location.origin && !("rocketboost" in linkElement.dataset)) {
    return;
  }
  ...
  if (!allowQueryString && linkElement.search && !("rocketboost" in linkElement.dataset)) {
    return;
  }
